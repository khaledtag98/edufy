  ...
  <app-layout>
    <div class="container mx-auto py-20">
      <div class="flex w-full h-full">
        ...
        <div class="w-1/4">
          <div>
            <div class="flex w-full pl-3 mt-10">
              <button
                @click="show = !show"
                class="
                  inline-flex
            ...
            <div class="p-2">
              <div class="mx-auto w-11/12 ">
                <div
                  ...
                  :style="
                    show == true
                      ? 'max-height: ' + $refs.addProject.scrollHeight + 'px'
                      : ''
                  "
                  class="
                  space-y-3
